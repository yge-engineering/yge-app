...
import { buildJobExpenseYoy } from './job-expense-yoy';
...
describe('buildJobExpenseYoy', () => {
  it('compares two years for one job', () => {
    const r = buildJobExpenseYoy({
      jobId: 'j1',
      currentYear: 2026,
      expenses: [
  ...
  it('handles unknown job', () => {
    const r = buildJobExpenseYoy({ jobId: 'X', currentYear: 2026, expenses: [] });
