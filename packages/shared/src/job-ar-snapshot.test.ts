...
import { buildJobArSnapshot } from './job-ar-snapshot';
...
describe('buildJobArSnapshot', () => {
  it('filters invoices to one job', () => {
    const r = buildJobArSnapshot({
      jobId: 'j1',
      asOf: '2026-04-30',
      arInvoices: [
        ar({ id: 'a', jobId: 'j1', totalCents: 100_000_00 }),
        ar({ id: 'b', jobId: 'j2', totalCents: 50_000_00 }),
      ],
      arPayments: [],
    });
