...
describe('buildBillingPaceReport', () => {
  ...
  it('adjustedContract includes EXECUTED + APPROVED COs', () => {
    const r = buildBillingPaceReport({
      ...
      apInvoices: [],
      changeOrders: [
        co({ id: 'a', status: 'EXECUTED', amountCents: 100_000_00 }),
        co({ id: 'b', status: 'APPROVED', amountCents: 50_000_00 }),
        co({ id: 'c', status: 'PROPOSED', amountCents: 999_999_00 }),
        co({ id: 'd', status: 'REJECTED', amountCents: 999_999_00 }),
      ],
      originalContractByJobId: new Map([['job-1', 1_000_000_00]]),
      budgetByJobId: new Map([['job-1', 800_000_00]]),
    });
