...
export default function TodayScreen() {
  ...
  return (
    ...
    >
      ...
      >
        <View>
          <Text style={{ fontSize: 14, fontWeight: '700', color: '#1e40af' }}>🌦 Weather</Text>
          <Text style={{ fontSize: 12, color: '#3b82f6', marginTop: 2 }}>
            Conditions & lost-time log
          </Text>
        </View>
        <Text style={{ fontSize: 18, color: '#1e40af' }}>→</Text>
      </Pressable>
      ...
      >
        <View>
          <Text style={{ fontSize: 14, fontWeight: '700', color: '#1e40af' }}>🧰 Tools</Text>
          <Text style={{ fontSize: 12, color: '#3b82f6', marginTop: 2 }}>
            Checkout status by tool
          </Text>
        </View>
        <Text style={{ fontSize: 18, color: '#1e40af' }}>→</Text>
      </Pressable>
      ...
      <Pressable
        onPress={() => navigation.navigate('Swppp')}
        style={{
          marginBottom: 12,
          padding: 14,
          borderRadius: 8,
      ...
      >
        <View>
          <Text style={{ fontSize: 14, fontWeight: '700', color: '#1e40af' }}>💧 SWPPP</Text>
          <Text style={{ fontSize: 12, color: '#3b82f6', marginTop: 2 }}>
      ...
      <Pressable
        onPress={() => navigation.navigate('EquipmentInspections')}
        style={{
          marginBottom: 12,
          padding: 14,
          borderRadius: 8,
      ...
      >
        <View>
          <Text style={{ fontSize: 14, fontWeight: '700', color: '#1e40af' }}>🚜 Equipment</Text>
          <Text style={{ fontSize: 12, color: '#3b82f6', marginTop: 2 }}>
      ...
      <Pressable
        onPress={() => navigation.navigate('Jsas')}
        style={{
          marginBottom: 12,
          padding: 14,
          borderRadius: 8,
      ...
      >
        <View>
          <Text style={{ fontSize: 14, fontWeight: '700', color: '#1e40af' }}>📋 JSAs</Text>
          <Text style={{ fontSize: 12, color: '#3b82f6', marginTop: 2 }}>
            Job safety analyses by shift
          </Text>
        </View>
        <Text style={{ fontSize: 18, color: '#1e40af' }}>→</Text>
      </Pressable>
