...
// Client-side text filter for /jobs list. Toggles row visibility
// based on each row's data-search attribute. Pure DOM, no server.
...
export function JobsSearchInput({ targetId, totalCount }: Props) {
