...
const QUICK_ACTIONS: QuickActionSpec[] = [
  ...
  { label: '+ New work order',      href: '/equipment-service-records/new', group: 'New', requires: 'safety:edit' },
  ...
  { label: 'OSHA 300 log',          href: '/osha-300',              group: 'Reports', requires: 'safety:view' },
  { label: 'Lien calendar',         href: '/lien-calendar',         group: 'Reports', requires: 'financials:view' },
  { label: '+ New JSA',             href: '/jsas/new',              group: 'New', requires: 'safety:edit' },
  { label: '+ New fixed asset',     href: '/fixed-assets/new',      group: 'New', requires: 'financials:edit' },
  { label: 'Fringe calculator',     href: '/fringe-calculator',     group: 'Reports', requires: 'financials:view' },
  { label: 'Stop-payment notice',   href: '/stop-payment-notice',   group: 'Reports', requires: 'financials:edit' },
  { label: 'PW compliance forms',   href: '/pw-forms',              group: 'Reports', requires: 'safety:view' },
...
const NAV_SPEC: NavGroupSpec[] = [
  ...
  {
    // AR / AP — the day-to-day money movement. Bookkeeper's home.
    key: 'nav.group.arap',
    links: [
  ...
  {
    // Calculators + chase lists + special-purpose tools.
    key: 'nav.group.tools',
    links: [
      ...
      { key: 'nav.comparables', href: '/comparables' },
  ...
  {
    // Safety + PW compliance (was crammed under money).
    key: 'nav.group.safety',
    links: [
  ...
  {
    // Audit / admin / portals (was crammed under money).
    key: 'nav.group.admin',
    links: [
      { key: 'nav.backups', href: '/backups', requires: 'audit:view' },
  ...
  },
  {
    ...
    links: [
      ...
      { key: 'nav.extension', href: '/extension' },
