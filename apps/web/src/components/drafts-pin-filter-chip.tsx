...
const STORAGE_KEY = 'yge.drafts.pinFilter';
const PIN_KEY = 'yge.drafts.pinnedIds';
const PIN_EVENT = 'yge:drafts-pinned-changed';
...
export function DraftsPinFilterChip({ targetId }: Props) {
