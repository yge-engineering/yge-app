...
export function HireDateStatsPanel() {
  ...
  const withDate = employees.filter((e) => !!e.hireDate).length;
  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <Stat label="With hire date" value={String(withDate)} sub={`of ${total} employees`} tone={pct >= 90 ? 'good' : pct >= 60 ? 'warn' : 'bad'} />
