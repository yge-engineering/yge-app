...
interface Employee { id: string; classification?: string | null }

export function ByClassStats() {
        ...
        <tbody>
          {rows.map(([cls, count]) => (
            <tr key={cls} className="border-t border-gray-100">
              <td className="px-3 py-2 font-semibold text-gray-900">{cls}</td>
              ...
              <td className="px-3 py-2 text-right">
                <Link href="/employees/by-classification-detail" className="text-xs text-yge-blue-700 hover:underline">view</Link>
              </td>
            </tr>
          ))}
        </tbody>
