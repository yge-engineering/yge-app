...
export function YearHiredStatsPanel() {
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
      <Stat label="Busiest year" value={top ? top[0] : '—'} sub={top ? `${top[1]} hires` : 'no hires dated yet'} />
      <Stat label="Unique years" value={String(counts.size)} sub={`across ${employees.length - missing} hires`} />
