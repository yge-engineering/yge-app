import { PrintDomainPanel } from './print-domain-panel';

export const dynamic = 'force-dynamic';

export default function CustomersByDomainPrintPage() {
  return (
    <main className="mx-auto max-w-3xl bg-white p-8 print:p-0">
      <header className="mb-4 border-b border-gray-300 pb-3">
        <h1 className="text-2xl font-bold text-gray-900">Customers by email domain</h1>
