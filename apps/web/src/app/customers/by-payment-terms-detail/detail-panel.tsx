...
export function ByPaymentTermsDetail() {
  ...
  return (
    <div className="space-y-3">
      {sorted.map(([terms, list]) => (
        <details key={terms} className="rounded border border-gray-200 bg-white shadow-sm">
          <summary className="flex cursor-pointer items-center justify-between px-3 py-2 text-sm">
            <span className="font-mono font-semibold">{terms}</span>
