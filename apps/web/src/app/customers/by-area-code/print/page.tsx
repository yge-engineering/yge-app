import { PrintAreaCodePanel } from './print-area-code-panel';

export const dynamic = 'force-dynamic';

export default function CustomersByAreaCodePrintPage() {
  return (
    <main className="mx-auto max-w-3xl bg-white p-8 print:p-0">
      <header className="mb-4 border-b border-gray-300 pb-3">
        <h1 className="text-2xl font-bold text-gray-900">Customers by area code</h1>
