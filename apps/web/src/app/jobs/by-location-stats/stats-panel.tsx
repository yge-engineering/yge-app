...
export function ByLocationStats() {
        ...
        <tbody>
          {rows.map(([loc, count]) => (
            <tr key={loc} className="border-t border-gray-100">
              <td className="px-3 py-2 text-gray-900">{loc}</td>
              ...
              <td className="px-3 py-2 text-right">
                <Link href="/jobs/by-location-detail" className="text-xs text-yge-blue-700 hover:underline">view</Link>
              </td>
            </tr>
          ))}
        </tbody>
