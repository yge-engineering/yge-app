...
export function ByLocationDetail() {
  ...
  return (
    <div className="space-y-3">
      {sorted.map(([loc, list]) => (
        <details key={loc} className="rounded border border-gray-200 bg-white shadow-sm">
          <summary className="flex cursor-pointer items-center justify-between px-3 py-2 text-sm">
            <span className="font-semibold text-gray-900">{loc}</span>
