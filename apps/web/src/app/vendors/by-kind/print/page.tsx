import { PrintKindPanel } from './print-kind-panel';

export const dynamic = 'force-dynamic';

export default function VendorsByKindPrintPage() {
  return (
    <main className="mx-auto max-w-3xl bg-white p-8 print:p-0">
      <header className="mb-4 border-b border-gray-300 pb-3">
        <h1 className="text-2xl font-bold text-gray-900">Vendors by kind</h1>
