...
export default function VendorsByAreaCodeDetailPage() {
  requirePermission('financials:view');
  return (
    <AppShell>
      <main className="mx-auto max-w-4xl">
        <PageHeader title="Vendors by area code (detail)" subtitle="Each area code expands to the actual vendors in that 3-digit prefix." />
