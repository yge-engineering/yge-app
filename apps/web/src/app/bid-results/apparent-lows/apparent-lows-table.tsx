...
import { ygeBid, ygeRank, type BidResult } from '@yge/shared';
...
export function ApparentLowsTable() {
        ...
        <tbody>
          {rows.map((r) => (
            <tr key={r.id} className="border-t border-gray-100">
              ...
              <td className="px-3 py-2 text-right font-mono"><Money cents={r.ygeAmount} /></td>
            </tr>
          ))}
        </tbody>
      </table>
