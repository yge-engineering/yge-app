import { PrintMissingPanel } from './print-missing-panel';

export const dynamic = 'force-dynamic';

export default function AtAGlanceMissingPrintPage() {
  return (
    <main className="mx-auto max-w-2xl bg-white p-8 print:p-0">
      <header className="mb-4 border-b border-gray-300 pb-3">
        <h1 className="text-2xl font-bold text-gray-900">Missing-field totals</h1>
