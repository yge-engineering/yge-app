...
import { jobsPipelineForecastRouter } from './routes/jobs-pipeline-forecast';
import { jobsStatsRouter } from './routes/jobs-stats';
...
import { equipmentInspectionsRouter } from './routes/equipment-inspections';
import { planTakeoffsRouter } from './routes/plan-takeoffs';
import { jsasRouter } from './routes/jsas';
import { fixedAssetsRouter } from './routes/fixed-assets';
import { equipmentServiceRecordsRouter } from './routes/equipment-service-records';
...
import { laborRatesRouter } from './routes/labor-rates';
...
app.use('/api/jobs', jobsStatsRouter);
...
app.use('/api/plan-takeoffs', planTakeoffsRouter);
app.use('/api/jsas', jsasRouter);
app.use('/api/fixed-assets', fixedAssetsRouter);
app.use('/api/equipment-service-records', equipmentServiceRecordsRouter);
